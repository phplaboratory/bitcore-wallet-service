...
TxProposal.prototype._buildTx = function() {
  ...
  $.checkState(totalInputs - totalOutputs <= Defaults.MAX_TX_FEE);
    ...
    console.log("TxProposal.prototype._buildTx   :" +self.network);
...
TxProposal.prototype._addSignaturesToBitcoreTx = function(tx, signatures, xpub) {
  ...
  console.log("TxProposal.prototype._addSignaturesToBitcoreTx");
  console.log("TxProposal.prototype._addSignaturesToBitcoreTx tx:"+tx.network);
  //console.log("TxProposal.prototype._addSignaturesToBitcoreTx getNetwork:"+tx.getNetwork());

  console.log(tx);
  var SIGHASH= Bitcore.crypto.Signature.SIGHASH_ALL;
  if (tx.network === 'bcctestnet' || tx.network === 'bcclivenet') {
    SIGHASH= Bitcore.crypto.Signature.SIGHASH_ALL | Bitcore.crypto.Signature.SIGHASH_FORKID;
    console.log("TxProposal.prototype._addSignaturesToBitcoreTx add BCC");
  }
//    SIGHASH= Bitcore.crypto.Signature.SIGHASH_ALL | Bitcore.crypto.Signature.SIGHASH_FORKID;
